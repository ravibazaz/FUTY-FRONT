...
export default function NewPlayerPage() {
    const [state, formAction] = useActionState(createPlayers, {
        success: null,
        errors: {},
    });
    ...
    const handleSubmit = async (e) => {
        ...
        const result = PlayersSchema(false).safeParse(raw);
                                ...
                                <div className="left-info-box">
                                    <div className="left-row row">
                                        ...
                                        <div className="left-info-col col-md-7 col-lg-8 col-xl-8">
                                            <div className="info-text px-0">
                                                <p className="mb-0">
                                                    <input name="palyer_position" className="form-control" min={0} max={100} type="number"></input>
                                ...
                                <div className="left-info-box">
                                    <div className="left-row row">
                                        ...
                                        <div className="left-info-col col-md-7 col-lg-8 col-xl-8">
                                            <div className="info-text px-0">
                                                <p className="mb-0">
                                                    <input name="palyer_pace" className="form-control" min={0} max={100} type="number"></input>
                                                    <span className="d-inline-block mt-10" >(between 0 and 100)</span>
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <div className="left-info-box">
                                    <div className="left-row row">
                                        ...
                                        <div className="left-info-col col-md-7 col-lg-8 col-xl-8">
                                            <div className="info-text px-0">
                                                <p className="mb-0">
                                                    <input name="palyer_skill" className="form-control" min={0} max={100} type="number"></input>
                                                    <span className="d-inline-block mt-10" >(between 0 and 100)</span>
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <div className="left-info-box">
                                    <div className="left-row row">
                                        ...
                                        <div className="left-info-col col-md-7 col-lg-8 col-xl-8">
                                            <div className="info-text px-0">
                                                <p className="mb-0">
                                                    <input name="palyer_power" className="form-control" min={0} max={100} type="number"></input>
                                                    <span className="d-inline-block mt-10" >(between 0 and 100)</span>
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <div className="left-info-box">
                                    <div className="left-row row">
                                        ...
                                        <div className="left-info-col col-md-7 col-lg-8 col-xl-8">
                                            <div className="info-text px-0">
                                                <p className="mb-0">
                                                    <input name="palyer_defence" className="form-control" min={0} max={100} type="number"></input>
                                                    <span className="d-inline-block mt-10" >(between 0 and 100)</span>
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <div className="left-info-box">
                                    <div className="left-row row">
                                        ...
                                        <div className="left-info-col col-md-7 col-lg-8 col-xl-8">
                                            <div className="info-text px-0">
                                                <p className="mb-0">
                                                    <input name="palyer_teamwork" className="form-control" min={0} max={100} type="number"></input>
                                                    <span className="d-inline-block mt-10" >(between 0 and 100)</span>
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <div className="left-info-box">
                                    <div className="left-row row">
                                        ...
                                        <div className="left-info-col col-md-7 col-lg-8 col-xl-8">
                                            <div className="info-text px-0">
                                                <p className="mb-0">
                                                    <input name="palyer_discipline" className="form-control" min={0} max={100} type="number"></input>
                                                    <span className="d-inline-block mt-10" >(between 0 and 100)</span>
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <div className="left-info-box">
                                    <div className="left-row row">
                                        ...
                                        <div className="left-info-col col-md-7 col-lg-8 col-xl-8">
                                            <div className="info-text px-0">
                                                <p className="mb-0">
                                                    <input name="palyer_rating" className="form-control" min={0} max={100} type="number"></input>
                                                    <span className="d-inline-block mt-10" >(between 0 and 100)</span>
                                                </p>
                                            </div>
                                        </div>
