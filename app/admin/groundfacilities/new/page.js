...
import { createGroundFacilities } from "@/actions/groundfacilitiesActions";
...
export default function NewGroundFacilityPage() {
  const [state, formAction] = useActionState(createGroundFacilities, {
    success: null,
    errors: {},
  });
      ...
      <main className="main-body col-md-9 col-lg-9 col-xl-10">
        ...
        <div className="body-title-bar d-flex flex-wrap justify-content-between align-items-center gap-20 mb-20">
          <div className="body-title-bar-left d-flex flex-wrap align-items-center gap-20-70">
            <h1 className="page-title">Add New Ground Facility</h1>
                  ...
                  <div className="left-row row">
                    <div className="left-label-col col-md-5 col-lg-4 col-xl-4">
                      <div className="label-text">
                        <p className="mb-0">Ground Facility Title</p>
                      </div>
                    </div>
                    <div className="left-info-col col-md-7 col-lg-8 col-xl-8">
                      <div className="info-text px-0">
                        <p className="mb-0">
                          <input className="form-control" name="facilities" type="text"></input>
                          {state.errors?.facilities && (
                            <span className="invalid-feedback" style={{ display: "block" }}>{state.errors.facilities}</span>
                          )}
                          {clientErrors.facilities && (
                            <span className="invalid-feedback" style={{ display: "block" }} >{clientErrors.facilities}</span>
                          )}
                        </p>
                      </div>
                    </div>
