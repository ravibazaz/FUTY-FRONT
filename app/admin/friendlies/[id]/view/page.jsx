...
export default async function ViewFansPage({ params }) {
    ...
    await connectDB();
    const friendlies = await Friendlies.findById(id).populate('ground_id').populate({
            ...
            <main className="main-body col-md-9 col-lg-9 col-xl-10">
                <div className="body-top d-flex flex-wrap justify-content-between align-items-center gap-20 mb-10">
                    <div className="top-left">
                        <p className="top-breadcrumb mb-0">{'> Friendlies'}</p>
                    </div>
                        ...
                        <div className="single-body-left col-lg-12 col-xl-7">
                            ...
                            <div className="left-info-box">
                                <div className="left-row row">
                                    <div className="left-label-col col-md-5 col-lg-4 col-xl-4">
                                        <div className="label-text">
                                            <p className="mb-0">Score who created friendly</p>
                                        </div>
                                    </div>
                                    <div className="left-info-col col-md-7 col-lg-8 col-xl-8">
                                        <div className="info-text">
                            ...
                            <div className="left-info-box">
                                <div className="left-row row">
                                    <div className="left-label-col col-md-5 col-lg-4 col-xl-4">
                                        <div className="label-text">
                                            <p className="mb-0">Score who accepted friendly</p>
                                        </div>
                                    </div>
                                    <div className="left-info-col col-md-7 col-lg-8 col-xl-8">
                                        <div className="info-text">
                            ...
                            {/* <div className="left-info-box">
                                <div className="left-row row">
                                    ...
                                    <div className="left-info-col col-md-7 col-lg-8 col-xl-8">
                                        <div className="info-text">
                                            <p className="mb-0">
                                                <a className="text-primary text-decoration-none" href="#">{friendlies.material}</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="left-info-box">
                                <div className="left-row row">
                                    ...
                                    <div className="left-info-col col-md-7 col-lg-8 col-xl-8">
                                        <div className="info-text">
                                            <p className="mb-0">
                                                <a className="text-primary text-decoration-none" href="#">{friendlies.product_code}</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="left-info-box">
                                <div className="left-row row">
                                    ...
                                    <div className="left-info-col col-md-7 col-lg-8 col-xl-8">
                                        <div className="info-text">
                                            <p className="mb-0">
                                                <a className="text-primary text-decoration-none" href="#">{friendlies.other_product_info}</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="single-body-right col-lg-12 col-xl-5">
                            <div className="right-info-box">
                                ...
                                <div className="right-info mb-30">
                                    {/* <Link href={`/admin/stores/${friendlies._id}/edit`}>
                                        <Image
                                            src={preview}
                                            width={82}
                                            height={82}
                                    ...
                                    <p className="mb-0">
                                        <Link className="text-decoration-none fs-14 fw-bold text-primary underline-hover" href={`/admin/stores/${friendlies._id}/edit`}>Product Badge</Link>
                                    </p> */}
                                </div>
                            </div>
                        </div>
