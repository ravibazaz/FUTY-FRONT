...
import { deleteFriendlys } from "@/actions/friendliesActions";
...
export default function GroundTable() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const res = await fetch("/api/friendlys");
        const result = await res.json();
        //console.log(result);
        setFriendlies(result.friendlies || []);
      } catch (err) {
      ...
      <main className="main-body col-md-9 col-lg-9 col-xl-10">
        <div className="body-top d-flex flex-wrap justify-content-between align-items-center gap-20 mb-10">
          ...
          <div className="top-right d-flex justify-content-between align-items-center gap-10">
            {/* <Link className="btn btn-common" href={`/admin/friendlies/new`} >New</Link> */}
            <a href="#">
        ...
        <div className="body-title-bar d-flex flex-wrap justify-content-between align-items-center gap-20 mb-10">
          <div className="body-title-bar-left d-flex flex-wrap align-items-center gap-20-70">
            <h1 className="page-title">Friendlies</h1>
                    ...
                    <tr key={l._id}>
                      ...
                      <td className="text-nowrap">
                        ...
                        <form
                          ...
                          action={deleteFriendlys.bind(null, l._id)}
                        />
                      </td>
                    </tr>
                  ))
