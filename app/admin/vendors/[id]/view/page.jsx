...
export default async function ViewFansPage({ params }) {
    ...
    await connectDB();
    const advert = await Vendors.findById(id).lean();
            ...
            <main className="main-body col-md-9 col-lg-9 col-xl-10">
                <div className="body-top d-flex flex-wrap justify-content-between align-items-center gap-20 mb-10">
                    <div className="top-left">
                        <p className="top-breadcrumb mb-0">{'> Vendor'}</p>
                    </div>
                            ...
                            <div className="left-info-box">
                                <div className="left-row row">
                                    ...
                                    <div className="left-info-col col-md-7 col-lg-8 col-xl-8">
                                        <div className="info-text">
                                            <p className="mb-0">
                                                <Link className="btn-common-text" href={`/admin/vendors/${advert._id}/edit`} >Edit</Link>
                                                <Link className="btn-common-text ps-3" href={`/admin/vendors`} >Back</Link>
                        ...
                        <div className="single-body-right col-lg-12 col-xl-5">
                            <div className="right-info-box">
                                ...
                                <div className="right-info mb-30">
                                    ...
                                    <p className="mb-0">
                                        <Link className="text-decoration-none fs-14 fw-bold text-primary underline-hover" href={`/admin/vendors/${advert._id}/edit`}>Vendor Badge</Link>
                                    </p>
                                </div>
                            </div>
                        </div>
