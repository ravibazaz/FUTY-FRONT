...
import { createVendors } from "@/actions/vendorsActions";
...
export default function NewGroundPage() {
  const [state, formAction] = useActionState(createVendors, {
    success: null,
    errors: {},
  });
  ...
  const handleSubmit = async (e) => {
    ...
    const result = VendorsSchema(false).safeParse(raw);
                  ...
                  <div className="left-row row">
                    <div className="left-label-col col-md-5 col-lg-4 col-xl-4">
                      <div className="label-text">
                        <p className="mb-0">Vendor Title</p>
                      </div>
                    </div>
