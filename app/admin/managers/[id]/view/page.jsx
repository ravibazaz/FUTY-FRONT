    ...
    <>
      <main className="main-body col-md-9 col-lg-9 col-xl-10">
        ...
        <div className="body-main-cont">
          ...
          <FriendliesTable friendlies={JSON.parse(JSON.stringify(todays_friendlies_created_me))} label="Schedules Friendlies"></FriendliesTable>
          <FriendliesTable friendlies={JSON.parse(JSON.stringify(archive_friendlies_created_me))} label="Archive"></FriendliesTable>
        </div>
