...
import { deleteTournaments } from "@/actions/tournamentsActions";
...
export default function GroundTable() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined" && window.$ && tournaments.length > 0) {
      const $ = window.$;
      ...
      <main className="main-body col-md-9 col-lg-9 col-xl-10">
        <div className="body-top d-flex flex-wrap justify-content-between align-items-center gap-20 mb-10">
          ...
          <div className="top-right d-flex justify-content-between align-items-center gap-10">
            {/* <Link className="btn btn-common" href={`/admin/tournaments/new`} >New</Link> */}
            <a href="#">
            ...
            <table id="example" className="table">
              ...
              <tbody>
                {tournaments.length > 0 ? (
                  tournaments.map((l, index) => (
                    <tr key={l._id}>
                      <td className="text-nowrap user-active"><Link prefetch={false} 
                        href={`/admin/tournaments/${l._id}/view`}
                      >
                        {l.name}
                      </Link></td>
                      ...
                      <td className="text-nowrap">
                        {/* <Link prefetch={false}  className="text-green"
                          href={`/admin/tournaments/${l._id}/edit`}
                        >
                          Edit
                        </Link> */}
                        ...
                        <form
                          ...
                          action={deleteTournaments.bind(null, l._id)}
                        />
