# app/api/referees/signup/route.js

## Description

This route handles `GET` requests for signed-up referee accounts.
...
- This route is read-only and used for retrieving registered referee accounts.
- Additional filtering, pagination, or authorization would need to be added separately.
