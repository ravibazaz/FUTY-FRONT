...
# GET /api/uploads/tournaments/[filename]

## Purpose

Serves uploaded files from the `tournaments` file upload directory.

## File Location

`app/api/uploads/tournaments/[filename]/route.js`
...
- Serves the file from `uploads/tournaments/{filename}` on disk.
