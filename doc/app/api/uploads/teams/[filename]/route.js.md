...
# GET /api/uploads/teams/[filename]

## Purpose

Serves uploaded files from the `teams` file upload directory.

## File Location

`app/api/uploads/teams/[filename]/route.js`
...
- Serves the file from `uploads/teams/{filename}` on disk.
