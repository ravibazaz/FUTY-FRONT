...
# GET /api/uploads/grounds/[filename]

## Purpose

Serves uploaded files from the `grounds` file upload directory.

## File Location

`app/api/uploads/grounds/[filename]/route.js`
...
- Serves the file from `uploads/grounds/{filename}` on disk.
