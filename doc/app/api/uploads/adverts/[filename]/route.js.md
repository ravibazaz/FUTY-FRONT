...
# GET /api/uploads/adverts/[filename]

## Purpose

Serves uploaded files from the `adverts` file upload directory.

## File Location

`app/api/uploads/adverts/[filename]/route.js`
...
- Serves the file from `uploads/adverts/{filename}` on disk.
