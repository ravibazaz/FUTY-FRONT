...
# GET /api/uploads/managers/[filename]

## Purpose

Serves uploaded files from the `managers` file upload directory.

## File Location

`app/api/uploads/managers/[filename]/route.js`
...
- Serves the file from `uploads/managers/{filename}` on disk.
