...
# GET /api/uploads/players/[filename]

## Purpose

Serves uploaded files from the `players` file upload directory.

## File Location

`app/api/uploads/players/[filename]/route.js`
...
- Serves the file from `uploads/players/{filename}` on disk.
