...
# GET /api/uploads/leagues/[filename]

## Purpose

Serves uploaded files from the `leagues` file upload directory.

## File Location

`app/api/uploads/leagues/[filename]/route.js`
...
- Serves the file from `uploads/leagues/{filename}` on disk.
