...
# GET /api/uploads/vendors/[filename]

## Purpose

Serves uploaded files from the `vendors` file upload directory.

## File Location

`app/api/uploads/vendors/[filename]/route.js`
...
- Serves the file from `uploads/vendors/{filename}` on disk.
