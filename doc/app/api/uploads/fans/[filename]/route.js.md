...
# GET /api/uploads/fans/[filename]

## Purpose

Serves uploaded files from the `fans` file upload directory.

## File Location

`app/api/uploads/fans/[filename]/route.js`
...
- Serves the file from `uploads/fans/{filename}` on disk.
