...
# GET /api/uploads/referees/[filename]

## Purpose

Serves uploaded files from the `referees` file upload directory.

## File Location

`app/api/uploads/referees/[filename]/route.js`
...
- Serves the file from `uploads/referees/{filename}` on disk.
