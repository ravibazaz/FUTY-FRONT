# Admin Detail View Page: Vendors Id View

## Purpose & Responsibility

View individual vendors records
...
| Aspect | Details |
|--------|---------|
| **File Location** | `app/admin/vendors/[id]/view/page.jsx` |
...
- Displays read-only details of vendors records
