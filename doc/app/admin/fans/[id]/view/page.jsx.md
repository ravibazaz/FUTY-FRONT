# Admin Detail View Page: Fans Id View

## Purpose & Responsibility

View individual fans records
...
| Aspect | Details |
|--------|---------|
| **File Location** | `app/admin/fans/[id]/view/page.jsx` |
...
- Displays read-only details of fans records
