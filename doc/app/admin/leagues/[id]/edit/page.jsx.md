# Admin Edit Page: Leagues Id Edit

## Purpose & Responsibility

Edit existing leagues records
...
| Aspect | Details |
|--------|---------|
| **File Location** | `app/admin/leagues/[id]/edit/page.jsx` |
...
- Allows editing of existing leagues records
