# Admin Creation Page: Leagues   Copy New

## Purpose & Responsibility

Create new leagues - Copy entries
...
| Aspect | Details |
|--------|---------|
| **File Location** | `app/admin/leagues - Copy/new/page.js` |
...
- Allows admins to create new leagues - Copy records
