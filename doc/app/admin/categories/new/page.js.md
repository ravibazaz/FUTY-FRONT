# Admin Creation Page: Categories New

## Purpose & Responsibility

Create new categories entries
...
| Aspect | Details |
|--------|---------|
| **File Location** | `app/admin/categories/new/page.js` |
...
- Allows admins to create new categories records
