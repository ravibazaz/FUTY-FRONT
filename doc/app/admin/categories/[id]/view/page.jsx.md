# Admin Detail View Page: Categories Id View

## Purpose & Responsibility

View individual categories records
...
| Aspect | Details |
|--------|---------|
| **File Location** | `app/admin/categories/[id]/view/page.jsx` |
...
- Displays read-only details of categories records
