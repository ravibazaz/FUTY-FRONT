# Admin Edit Page: Categories Id Edit

## Purpose & Responsibility

Edit existing categories records
...
| Aspect | Details |
|--------|---------|
| **File Location** | `app/admin/categories/[id]/edit/page.jsx` |
...
- Allows editing of existing categories records
