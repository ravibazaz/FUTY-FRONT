# Admin Detail View Page: Friendlies Id View

## Purpose & Responsibility

View individual friendlies records
...
| Aspect | Details |
|--------|---------|
| **File Location** | `app/admin/friendlies/[id]/view/page.jsx` |
...
- Displays read-only details of friendlies records
