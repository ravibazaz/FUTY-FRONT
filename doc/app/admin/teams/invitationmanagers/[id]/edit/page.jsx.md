# Admin Edit Page: Teams Invitationmanagers Id Edit

## Purpose & Responsibility

Edit existing teams records
...
| Aspect | Details |
|--------|---------|
| **File Location** | `app/admin/teams/invitationmanagers/[id]/edit/page.jsx` |
...
- Allows editing of existing teams records
