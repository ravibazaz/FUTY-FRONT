# Admin Detail View Page: Stores Id View

## Purpose & Responsibility

View individual stores records
...
| Aspect | Details |
|--------|---------|
| **File Location** | `app/admin/stores/[id]/view/page.jsx` |
...
- Displays read-only details of stores records
