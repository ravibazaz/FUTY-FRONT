# Admin Creation Page: Groundfacilities New

## Purpose & Responsibility

Create new groundfacilities entries
...
| Aspect | Details |
|--------|---------|
| **File Location** | `app/admin/groundfacilities/new/page.js` |
...
- Allows admins to create new groundfacilities records
