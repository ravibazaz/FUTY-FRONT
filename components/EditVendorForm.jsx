...
import { updateVendor } from "@/actions/vendorsActions";
...
function SubmitButton() {
  ...
  return (
    <>
      ...
      <Link className="btn-common-text mt-30 mb-30 ps-3" href={'/admin/vendors'}>Back</Link>
    </>
  )

}

export default function EditAdvertForm({ vendors }) {

    const [selectedpages ,setSelectedPages] = useState(vendors.pages ? vendors.pages : '');
  ...
  const [preview, setPreview] = useState(vendors.image ? '/api' + vendors.image : '/images/club-badge.jpg');
    ...
    <main className="main-body col-md-9 col-lg-9 col-xl-10">
      <div className="body-top d-flex flex-wrap justify-content-between align-items-center gap-20 mb-10">
        <div className="top-left">
          <p className="top-breadcrumb mb-0">{'> Vendors'}</p>
        </div>
            ...
            <div className="single-body-left col-lg-12 col-xl-7">
                ...
                <div className="left-row row">
                  ...
                  <div className="left-info-col col-md-7 col-lg-8 col-xl-8">
                    <div className="info-text px-0">
                      <p className="mb-0">
                        <input className="form-control" name="name" defaultValue={vendors.name} type="text" ></input>
                        {clientErrors.name && (
              ...
              <div className="left-info-box">
                <div className="left-row row">
                  ...
                  <div className="left-info-col col-md-7 col-lg-8 col-xl-8">
                    <div className="info-text px-0">
                      <p className="mb-0">
                        <input className="form-control" name="link" defaultValue={vendors.link} type="text" ></input>
                        {clientErrors.link && (
                          <span className="invalid-feedback" style={{ display: "block" }}>
                            {clientErrors.link}
                          </span>
              ...
              <div className="left-info-box">
                <div className="left-row row">
                  ...
                  <div className="left-info-col col-md-7 col-lg-8 col-xl-8">
                    <div className="info-text px-0">
                      <p className="mb-0">
                        <textarea className="form-control" defaultValue={vendors.content} name="content" ></textarea>
              ...
              <div className="left-info-box">
                <div className="left-row row">
                  <div className="left-label-col col-md-5 col-lg-4 col-xl-4">
                    <div className="label-text mb-0">
                      <p className="mb-0">Vendor image</p>
                    </div>
                  </div>
                  <div className="left-info-col col-md-7 col-lg-8 col-xl-8">
                    <div className="info-text px-0">
                      <div className="mb-0">
                        <div className="upload-box" id="uploadBox" onClick={handleUploadClick}>
                          ...
                          <p className="inputPlaceholder" id="placeholderText">Vendor Badge</p>
                        </div>
                        {clientErrors.image && (
                          <span className="invalid-feedback" style={{ display: "block" }}>
                            {clientErrors.image}
