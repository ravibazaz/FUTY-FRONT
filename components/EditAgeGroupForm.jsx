...
import { updateAgeGroups } from "@/actions/agegroupActions";
...
export default function EditAgeGroupForm({ agegroups }) {

  const fileInputRef = useRef(null);
  const previewsRef = useRef(null);

  const [state, formAction] = useActionState(
    updateAgeGroups.bind(null, agegroups._id),
    {
      success: null,
      errors: {},
    }
    ...
    <main className="main-body col-md-9 col-lg-9 col-xl-10">
      ...
      <div className="body-title-bar d-flex flex-wrap justify-content-between align-items-center gap-20 mb-20">
        <div className="body-title-bar-left d-flex flex-wrap align-items-center gap-20-70">
          <h1 className="page-title">Edit Age Group</h1>
        </div>
      </div>
                ...
                <div className="left-row row">
                  ...
                  <div className="left-info-col col-md-7 col-lg-8 col-xl-8">
                    <div className="info-text px-0">
                      <p className="mb-0">
                        <input className="form-control" name="age_group" defaultValue={agegroups.age_group} type="text" ></input>
              ...
              <div className="left-info-box">
                <div className="left-row row">
                  ...
                  <div className="left-info-col col-md-7 col-lg-8 col-xl-8">
                    <div className="info-text px-0">
                      <p className="mb-0">
                        <textarea className="form-control" defaultValue={agegroups.description} name="description" ></textarea>
