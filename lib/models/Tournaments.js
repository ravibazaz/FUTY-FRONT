...
// Virtual populate for all TournamentOrderHistories of this Tournament
TournamentSchema.virtual("tournamentorderhistories", {
  ref: "TournamentOrderHistories",         // model name
  localField: "_id",       // field in TournamentOrderHistories
  foreignField: "tournament_Id",    // field in TournamentOrderHistories
  justOne: false,          // ⬅️ allows multiple TournamentOrderHistories
});
